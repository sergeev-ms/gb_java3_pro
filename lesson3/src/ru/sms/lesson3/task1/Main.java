...
public class Main {
    ...
    static final String LESSON3_TASK1_RANDOM_FILE_TXT = "lesson3/Task1_randomFile.txt";
    ...
    public static void generateFile(byte[] bytes, String fileName) throws IOException {
